    ...
    <div id="homepage" class="section-group">
            ...
            <div class="container">
                ...
                <div class="content">
                    <div class="list chem ">
                        ...
                        <a href="" class="btn_ft hidden-xs">课程详情</a>
                    </div>
                    <div class="list phy ">
                ...
                <div class="teacher_list swiper-teacher">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="img" style="background-image:url(images/teachers/cy1.jpg);">
                                <div class="message">
                                    <h3>曹媛老师</h3>
                                    <span>毕业于清华大学</span>
        ...
        <section class="section about">
            <div class="container">
                ...
                <div class="aboutme">
                    <div class="title">
                        <img src="images/uploads/iconl.jpg" alt="">
                        <p>方田教育是一家成立于2014年7月，立志用科技改变学习，面向全国招生的中小学教育机构</p>
                    </div>
                    <ul>
                        <li><img src="images/teachers/fk.jpg" alt=""></li>
                        <li><img src="images/teachers/fk.jpg" alt=""></li>
                        <li><img src="images/teachers/fk.jpg" alt=""></li>
                    </ul>
                </div>
                <div class="wedo">
                    <img class="activity" src="images/uploads/active.jpg" alt="">
                    <div class="content">
                        <div class="right">
                            <p>方田教育致力于为6-18岁的孩子提供高品质的线下和在线课外辅导，在合肥成立4年以来，已成为合肥45中、48中、科大附中、寿春中学等学校家长和学生最信赖的中小学课外辅导品牌</p>
                            <img src="images/uploads/iconr.jpg" alt="">
                        </div>
                        <div class="more hidden-xs">
                            <a href="" class="btn_ft">马上报名</a>
                            <a href="" class="btn_ft">了解更多</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section location">
            <div class="container">
                ...
                <div class="col-sm-6 area_detail">
                    <dl>
                        <dt>亳州路校区：</dt>
                        <dd>
                            <p>庐阳区亳州路301号金地大厦8楼 </p>
                            <a href="tel:0551-65103070"> <span class="visible-xs glyphicon glyphicon-earphone"></span>65103070</a>
                        </dd>
                        <dt>安庆路校区：</dt>
                        <dd>
                            <p>庐阳区安庆路205号金子楼6楼</p>
                            <a href="tel:0551-65103992"> <span class="visible-xs glyphicon glyphicon-earphone"></span>65103992</a>
                        </dd>
                        <dt>五里墩校区：</dt>
                        <dd>
                            <p>蜀山区长江西路与合作化南路交口金域国际15楼</p>
                            <a href="tel:0551-65103821"> <span class="visible-xs glyphicon glyphicon-earphone"></span>65103821</a>
                        </dd>
                    </dl>
                    <dl>
                        <dt>工作时间</dt>
